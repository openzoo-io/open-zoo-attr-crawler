...
NFTITEM.index({ thumbnailPath: 1, isAppropriate: 1 });
NFTITEM.index({ contractAddress: 1, thumbnailPath: 1, isAppropriate: 1 });
NFTITEM.index({ contractAddress: 1, tokenID: -1 });
NFTITEM.index({ contractAddress: 1, tokenID: -1, isAppropriate: 1 });
